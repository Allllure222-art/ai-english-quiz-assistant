...
export function buildDocumentModel(bundle, { variant }) {
    // Keep reference for renderers that need raw bundle data (e.g. cloze inline blanks)
    ...
    return {
        ...
        passageParagraphs,
        questionBlocks,
        bundle,  // passed through for cloze inline-blank rendering in renderDocx
    }
}
